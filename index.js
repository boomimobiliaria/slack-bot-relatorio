...
const SLACK_BOT_TOKEN = 'xoxb-3795853291233-9393321713589-dG3gR6857Q4xOQy9aXgQ1HpO';
const SLACK_WEBHOOK_URL = 'https://hooks.slack.com/services/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';
  ...
  const modal = {
    ...
    blocks: [
      ...
      },
      {
        type: 'input',
        block_id: 'contas',
        label: { type: 'plain_text', text: 'Informe o valor das contas a pagar:' },
        element: { type: 'plain_text_input', action_id: 'valor' }
      },
      {
        type: 'input',
